class ChargesController < ApplicationController
  ...
  def create
    ...
    if current_user.email == params[:stripeEmail]
      # Amount in cents
      ...
      AdminMailer.send_purchase_confirmation_student( current_user, course ).deliver_later
      AdminMailer.send_purchase_confirmation_instructor( current_user, course ).deliver_later
      redirect_to course
    end
