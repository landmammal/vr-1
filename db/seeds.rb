...
User.create([{ first_name:'Administrator', last_name:'Man', username:'admin', race:'White', email:'admin@gmail.com', password:'admin123', password_confirmation:'admin123', age:Time.now, role: 0, approved: true},
			 { first_name:'Instructor', last_name:'Sir', username:'instructor', race:'Asian', email:'instructor@gmail.com', password:'instructor123', password_confirmation:'instructor123', age:Time.now, role: 1, approved: true},
...
Feedback.create(user_id: 3, rehearsal_id: 1, rehearsal_rating: 3, concept_review: '' , notes: 'U look funny' , token: '' , video_token: '7294030be33c26facf100ce2f6266fcd' , approved: true , viewed_by_user: false , video_type: 'ziggeo')
Feedback.create(user_id: 3, rehearsal_id: 1, rehearsal_rating: 1, concept_review: '' , notes: 'Do it again' , token: '' , video_token: '7294030be33c26facf100ce2f6266fcd' , approved: true , viewed_by_user: true , video_type: 'ziggeo')
# Feedback.create(user_id: 3, rehearsal_id: 1, rehearsal_rating: 5, concept_review: '' , notes: 'Perfect' , token: '' , video_token: '7294030be33c26facf100ce2f6266fcd' , approved: true , viewed_by_user: false , video_type: 'ziggeo')
