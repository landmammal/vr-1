...
User.create([{ first_name:'Administrator', last_name:'Man', username:'admin', race:'White', email:'admin@videorehearser.com', password:'admin123', password_confirmation:'admin123', age:Time.now, role: 0, approved: true},
			 { first_name:'Instructor', last_name:'Sir', username:'instructor', race:'Asian', email:'instructor@videorehearser.com', password:'instructor123', password_confirmation:'instructor123', age:Time.now, role: 1, approved: true},
			 { first_name:'Coach', last_name:'Jane', username:'coach', race:'White', email:'coach@videorehearser.com', password:'coach123', password_confirmation:'coach123', age:Time.now, role: 2, approved: true},
			 { first_name:'Student', last_name:'John', username:'trainee', race:'Black', email:'trainee@videorehearser.com', password:'trainee123', password_confirmation:'trainee123', age:Time.now, role: 3, approved: true}])
